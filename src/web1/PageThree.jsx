...
export default function PageThree() {
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="g1-p3" x1="0" x2="1">
      ...
      <h1 className="hidden md:block absolute left-[-5%] rotate-[-90deg] text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-200 via-green-300 to-yellow-200">
        2.Characteristics
      </h1>
      ...
      <div className="max-w-4xl md:ml-[18%] text-indigo-100/90 fade-in text-center md:text-left">
        ...
        <ul className="mt-6 text-xl space-y-3 md:list-disc list-none md:list-inside list-inside">
          ...
          <li>
            Limited Communication: Email and forums, no interactive websites.
          </li>
        </ul>
      </div>
    </section>
